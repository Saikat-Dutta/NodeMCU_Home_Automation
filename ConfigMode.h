...
<div class="centered">
  <form method="get" action="config">
    ...
    <tr><td><label for="blynk">Auth token:</label></td><td><input type="text" name="blynk" placeholder="a0b1c2d..." pattern="[-_a-zA-Z0-9]{32}" maxlength="32" value="iXSn7TrlYGbdagtzNU6YV1ANJqhsUaMR"></td></tr>
